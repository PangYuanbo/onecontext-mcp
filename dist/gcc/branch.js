...
import { gccBranchCommitMdPath, gccBranchCommitsJsonlPath, gccBranchDir, gccBranchLogJsonlPath, gccBranchMetadataPath, } from "./paths.js";
...
export function createBranch(opts) {
    ...
    const created = !pathExists(commitMd) && !pathExists(commitsJsonl) && !pathExists(logJsonl) && !pathExists(metadata);
